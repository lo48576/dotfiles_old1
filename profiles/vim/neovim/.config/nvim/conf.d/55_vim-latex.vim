NeoBundleLazy 'vim-latex/vim-latex' " Enhanced LaTeX support for Vim
...
" SKK is using C-j, so you can't use C-j to using place-holder.
imap <F3> <Plug>IMAP_JumpForward
nmap <F3> <Plug>IMAP_JumpForward
