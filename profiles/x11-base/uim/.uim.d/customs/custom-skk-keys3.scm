...
(define skk-commit-with-conv-completion-key '("<IgnoreCase><Control><Alt>j" "Muhenkan"))
(define skk-commit-with-conv-completion-key? (make-key-predicate '("<IgnoreCase><Control><Alt>j" "Muhenkan")))
