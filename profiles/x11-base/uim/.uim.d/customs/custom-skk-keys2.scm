...
(define skk-vi-escape-key '("escape" "<IgnoreShift><Control>[" "<IgnoreShift><Control>/"))
(define skk-vi-escape-key? (make-key-predicate '("escape" "<IgnoreShift><Control>[" "<IgnoreShift><Control>/")))
(define skk-state-direct-no-preedit-nop-key '("<IgnoreCase><Control>j" "<IgnoreCase><Control>y" "Muhenkan"))
(define skk-state-direct-no-preedit-nop-key? (make-key-predicate '("<IgnoreCase><Control>j" "<IgnoreCase><Control>y" "Muhenkan")))
