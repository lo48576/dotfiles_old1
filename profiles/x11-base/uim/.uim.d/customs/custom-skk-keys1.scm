...
(define skk-commit-key '("<IgnoreCase><Control>j" "<IgnoreCase><Control>y" "Muhenkan"))
(define skk-commit-key? (make-key-predicate '("<IgnoreCase><Control>j" "<IgnoreCase><Control>y" "Muhenkan")))
