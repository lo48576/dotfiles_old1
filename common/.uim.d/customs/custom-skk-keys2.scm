...
(define skk-state-direct-no-preedit-nop-key '("<IgnoreCase><Control>j" "<IgnoreCase><Control>y"))
(define skk-state-direct-no-preedit-nop-key? (make-key-predicate '("<IgnoreCase><Control>j" "<IgnoreCase><Control>y")))
